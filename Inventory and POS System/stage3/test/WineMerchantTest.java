...
//  @SwingComponent JPanelFixture orderListPanel;
    ...
    CheckResult test5_checkMiddlePanel() {
        merlotButton.click();
    ...
    CheckResult test6_checkValidName() {
    ...
    CheckResult test7_checkValidNumericValue() {
    ...
    CheckResult test8_checkSuccessfulMessage() {
    ...
    CheckResult test9_checkTabbedPane() {
    ...
    CheckResult test11_checkFilter() {
    ...
    @DynamicTest
    CheckResult test12_addNewSupplierToTableAndCheckWithDatabase() {
        tabbedPane.selectTab(0);
        roseButton.click();
